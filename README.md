...
This corpus's pilot subset has also been used to LoRA fine-tune
`numind/NuExtract3` specifically for TOC extraction — see
[finetune-nuextract-toc](https://github.com/cboulanger/finetune-nuextract-toc)
for the training/evaluation pipeline, and
[try the fine-tuned model in a live demo](https://huggingface.co/spaces/cmboulanger/nuextract3-toc-demo)
(upload a scanned TOC PDF, see the extracted entries).
